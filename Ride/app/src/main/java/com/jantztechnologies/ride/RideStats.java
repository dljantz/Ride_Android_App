...
public class RideStats implements Serializable {
    ...
    public String getTimeOfDayText() {
        ...
        try {
            ...
            // ride doesn't have calendar info, just return empty string
            return "View Ride"; // default action bar title
        }

        int hour = calendar.get(Calendar.HOUR_OF_DAY);
        String introString;
        if (hour >= 22 || hour <= 3) introString = "Night ride";
        else if (hour <= 11) introString = "Morning ride";
        else if (hour <= 17) introString = "Afternoon ride";
        else introString = "Evening ride";
    ...
    public String getDateText(boolean includeWeekDay) {
        ...
        try {
            ...
            // ride doesn't have calendar info, just return nothing for action bar subtitle
            return null;
        }
