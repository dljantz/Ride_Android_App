...
public class MapIllustrator {
    ...
    public void establishCameraBounds(double zoomOut) {
        ...
        try {
            ...
            // zoom out to the entire world if no ride2 data exists
            minLat = -25;
            minLong = -130;
            maxLat = 55;
            maxLong = 60;
        ...
        double latRange; // used to expand camera bounds so parts of the ride2 aren't right on the edge
        double longRange;
    ...
    public void generatePolylineOptions(int numSpeedColorCategories) {
        ...
        try {
            ...
            // expected result if ride2 length of zero, just pretend it never happened and move on in life
        }
