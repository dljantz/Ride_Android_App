...
public class StatisticsActivity extends AppCompatActivity {
    ...
    private ArrayList<RideStats> getOrderedRideStatsArrayList() {
        ...
        // Next, place only the ride2 folders from that list in a new array. Hopefully the null pointer exception is never thrown...
        ...
        // Then, make an Array out of the new arrayList of only ride2 folders. I didn't want to do this step, because
