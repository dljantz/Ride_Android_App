...
import com.jantztechnologies.ride2.databinding.ActivityViewRideBinding;
...
public class ViewRideActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private double zoomOut; // so the ride2 polyline doesn't go right up to the edge
    ...
    Runnable getNetworkElevationRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (acceptedLocations.get(acceptedLocations.size() - 1).getNetworkElevationMeters() == App.NO_ELEVATION_DATA) {
                ...
                //      gains internet access while reviewing their ride2, it can still load.
...
/*
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //      users think they can return to the ride2 they just finished.
        ...
        // get all the ride2 stats / path information
        ...
        speedGraph.redraw(rideStats.distanceMeters,
                          ...
                          0,
                          acceptedLocations,
                          null, // would be needed if I was drawing a graph of ride2 distance over a week or month
                          distanceUnits,
        ...
        // if this is the first ride2 and we're viewing it within the first 8 hours of recording,
    ...
    private void onDeleteRideClick(View view) {
        ...
        } else if (FileIO.deleteFolder(this, rideFolder)){ // they already clicked it once, time to actually delete ride2 data
    ...
    private void updateElevationStats(SerializableLocation location) {
        ...
        // case 1: for some reason no elevation data at all were acquired during the ride2,
        ...
        //      during the ride2, which can technically occur on ridiculously flat / short rides.
